...
public class Espalda_Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (Athele0 != null) {
            ...
            try {
                Times t = new Times(routi.findAll().get(temp).getNumber(),1, athele.findAll().get(0).getName(), Athele0);
                time.insert(t);
            } catch (SQLException ex) {
                Logger.getLogger(Espalda_Servlet.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if (Athele1 != null) {
            ...
            try {
                Times t = new Times(routi.findAll().get(temp).getNumber(),1, athele.findAll().get(1).getName(), Athele1);
                time.insert(t);
            } catch (SQLException ex) {
                Logger.getLogger(Espalda_Servlet.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if (Athele2 != null) {
            ...
            try {
                Times t = new Times(routi.findAll().get(temp).getNumber(),1, athele.findAll().get(2).getName(), Athele2);
                time.insert(t);
            } catch (SQLException ex) {
                Logger.getLogger(Espalda_Servlet.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if (Athele3 != null) {
            ...
            try {
                Times t = new Times(routi.findAll().get(temp).getNumber(),1, athele.findAll().get(3).getName(), Athele3);
                time.insert(t);
            } catch (SQLException ex) {
                Logger.getLogger(Espalda_Servlet.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if (Athele4 != null) {
            ...
            try {
                Times t = new Times(routi.findAll().get(temp).getNumber(),1, athele.findAll().get(4).getName(), Athele4);
                time.insert(t);
            } catch (SQLException ex) {
                Logger.getLogger(Espalda_Servlet.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if (Athele5 != null) {
            ...
            try {
                Times t = new Times(routi.findAll().get(temp).getNumber(),1, athele.findAll().get(5).getName(), Athele5);
                time.insert(t);
            } catch (SQLException ex) {
                Logger.getLogger(Espalda_Servlet.class.getName()).log(Level.SEVERE, null, ex);
            }
