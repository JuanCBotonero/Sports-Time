...
public class Pecho_Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (Athele0 != "0:00:00:00") {
            ...
            Times t;
            try {
                t = new Times(3, athele.findAll().get(0).getName(), Athele0);
        ...
        if (Athele1 != "0:00:00:00") {
            ...
            Times t;
            try {
                t = new Times(3, athele.findAll().get(1).getName(), Athele1);
            } catch (SQLException ex) {
                Logger.getLogger(Espalda_Servlet.class.getName()).log(Level.SEVERE, null, ex);
            }
            Routing r = new Routing(Cantidad, Distancia, Style);
        ...
        if (Athele2 != "0:00:00:00") {
            ...
            Times t;
            try {
                t = new Times(3, athele.findAll().get(2).getName(), Athele2);
            } catch (SQLException ex) {
                Logger.getLogger(Espalda_Servlet.class.getName()).log(Level.SEVERE, null, ex);
            }
            Routing r = new Routing(Cantidad, Distancia, Style);
        ...
        if (Athele3 != "0:00:00:00") {
            ...
            Times t;
            try {
                t = new Times(3, athele.findAll().get(3).getName(), Athele3);
            } catch (SQLException ex) {
                Logger.getLogger(Espalda_Servlet.class.getName()).log(Level.SEVERE, null, ex);
            }
            Routing r = new Routing(Cantidad, Distancia, Style);
        ...
        if (Athele4 != "0:00:00:00") {
            ...
            Times t;
            try {
                t = new Times(3, athele.findAll().get(4).getName(), Athele4);
            } catch (SQLException ex) {
                Logger.getLogger(Espalda_Servlet.class.getName()).log(Level.SEVERE, null, ex);
            }
            Routing r = new Routing(Cantidad, Distancia, Style);
        ...
        if (Athele5 != "0:00:00:00") {
            ...
            Times t;
            try {
                t = new Times(3, athele.findAll().get(5).getName(), Athele5);
            } catch (SQLException ex) {
                Logger.getLogger(Espalda_Servlet.class.getName()).log(Level.SEVERE, null, ex);
            }
            Routing r = new Routing(Cantidad, Distancia, Style);
